...
final class NewsController extends Controller implements DocumentsQueryParameters
{
    ...
    public function index(Request $request): AnonymousResourceCollection
    {
        ...
        $query = NewsItem::published()->with('translations')->latest('publish_at');
        ...
        $this->applyCountryScopeViaTerritory($query, $this->scopeConstraint($request), territoryNullable: true);

        return NewsItemResource::collection($query->paginate((int) ($validated['per_page'] ?? 24)));
    }
}

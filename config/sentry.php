...
return [
    ...
    // The last point before an event leaves this application: strips an
    // owner's phone number, email, or other personal data out of the
    // request payload, extra context, and exception messages before
    // transmission. See the class itself for what it does and does not
    // catch.
    'before_send' => [ScrubsPersonalDataBeforeSend::class, 'handle'],

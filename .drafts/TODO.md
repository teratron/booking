...
- [x] Технологический стек (последние и стабильные версии): React или NextJS, TypeScript, PNPM, Vite, <https://github.com/facebook/astryx> на рассмотрение или Tailwind CSS + shadcn/ui, Fallow, Biome, PostgreSQL. По мере вёрстки и разбора механик и функционала, по проекту в figme, будут появляться новые элементы технологического стека, предлагай их на рассмотрение (возможно некоторые могут меняться).

...
- [ ] на стадии запуска продакшена прекрутить Git Flow систему и автоматезировать с помощью ИИ, добавить документацию как пользоваться и настроить Git Flow на английском и русском языках в разных markdown-файлах
- [ ] документация (`*.md`) + промпт (`*.prompt.md`) по развёртыванию проекта на английском и русском языках в разных markdown-файлах
- [ ] всплывающее уведомление подтверждения cookies
- [ ] настройки для продакшена: .env.production, vite.config.js и т.д. со своими нюансами отличными от dev-версии
